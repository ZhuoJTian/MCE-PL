...
np.savetxt("./Data/CategoryToClients4.txt", CategoryToClients, fmt='%d')
'''
...
np.savetxt("./Data/LocalDist_niid_test4.txt", LocalDist_test_array, fmt='%d')
np.savetxt("./Data/LocalDist_niid4.txt", LocalDist_train_array, fmt='%d')
'''
